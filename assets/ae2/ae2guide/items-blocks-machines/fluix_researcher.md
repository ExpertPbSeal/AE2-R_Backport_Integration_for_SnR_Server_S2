...
| Master     | 8 <ItemLink id="minecraft:emerald" />             | 3 <ItemLink id="megacells:sky_steel_ingot" />                |
| Master     | 40 <ItemLink id="minecraft:emerald" />            | 1 <ItemLink id="megacells:accumulation_processor_press" />   |

**Note: All Master Trading Options, except the slime ball, would only show up one per villager.**
**Better grab your lucky lottery ticket...**